    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        |               (post.author --> user.id)
                            generates Post::user() and Users::posts()
        |
        ...
        |                       generates Post::author() and Users::posts_where_author()
        |                   (post.editor_id --> user.id)
        |                       generates Post::editor() and Users::posts_where_editor()
        ...
        */
        ...
        /*
         ...
         |
         | ...
         | $builder->select([Users::USER_NAME])->where(Users::AGE, '<=', 18);
         | ...
         |
